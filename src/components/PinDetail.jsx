...
const PinDetail = ({ user }) => {
    ...
    return (
        <>
            {pinDetail && (
                <div className="flex xl:flex-row flex-col p-2 md:p-4 bg-white" style={{ maxWidth: '1200px', borderRadius: '15px' }}>
                    ...
                    <div className="w-full p-5 flex-1 xl:min-w-620">
                        <div className="flex items-center justify-between">
                            ...
                            <a href={pinDetail.destination} target="_blank" rel="noreferrer" className='underline text-blue-400'>
